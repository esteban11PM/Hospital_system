...
import { strongPassword } from '../../Core/Utils/input-validators.utils';
...
export class FormUserComponent implements OnInit, OnChanges {
	...
	ngOnChanges(changes: SimpleChanges): void {
		...
		if (changes['roles'] && this.roles.length > 0 && this.userWrite) {
			this.formUser.patchValue({ roleId: this.userWrite.roleId });
		}
	...
	get isFormDisabled(): boolean {
		return this.formUser.invalid || this.noPersonsAvailable;
	}
}
