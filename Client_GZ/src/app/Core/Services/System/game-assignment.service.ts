...
import { GameAssignmentMod, GameAssignmentOptionsMod } from '../../Models/System/GameAssignmentMod.model';
...
export class GameAssignmentService extends GenericService<GameAssignmentOptionsMod, GameAssignmentMod> {

  constructor(http: HttpClient) {
    const urlBase = environment.apiURL + 'api/GameAssignment/';
    super(http, urlBase);
  }

  getAllJWT(): Observable<GameAssignmentMod[]>{
    return this.http.get<GameAssignmentMod[]>(`${this.baseUrl}GetAllJWT/`);
  }
}
